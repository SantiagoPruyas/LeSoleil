...
namespace LeSoleil_Taller2
{
    public partial class FormReporteVendedor : Form
    {
        ...
        public FormReporteVendedor(Usuario user)
        {
            InitializeComponent();
            usuarioActual = user;
        }
        ...
        private void BBuscar_Click(object sender, EventArgs e)
        {
            ...
            lista = new CN_Reporte().VentaVendedor(usuarioActual.Id_usuario,fechaInicio, fechaFin);
        ...
        private void BDescargarExcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReporteVentas{0}_{0}.xlsx", usuarioActual.Nombre.ToString() , DateTime.Now.ToString("ddMMyyyyHHmmss"));
